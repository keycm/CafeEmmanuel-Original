...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* --- About Hero Section (Left Aligned) --- */
        .about-hero {
            position: relative;
            height: 60vh;
            min-height: 450px;
            ...
            <div class="container">
                <div class="story-grid">
                    <div class="story-text">
                        <h2>Crafting Moments Since 2018</h2>
                    ...
                    <div class="story-img-wrapper">
                        <img src="https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=2694&auto=format&fit=crop" alt="Cafe Barista">
                    </div>
                </div>
            </div>
        </section>
