...
// --- FIXED: Use unified connection from config.php for registration ---
require_once 'config.php';
$conn_register = $conn;

// Ensure connection is valid
if (!isset($conn_register) || $conn_register->connect_error) {
    die("Connection failed: " . ($conn_register->connect_error ?? 'Database configuration error'));
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['register'])) {
    ...
    if (!preg_match("/^[a-zA-Z\s]+$/", $fullname)) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            $insert_stmt = $conn_register->prepare("INSERT INTO users (username, password, fullname, email, contact, gender) VALUES (?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header.scrolled {
            background: rgba(26, 18, 11, 0.98); /* Dark on scroll */
        ...
        .contact-hero {
            ...
            text-align: left;
            margin-top: -90px; /* Pull up behind header */
            padding-top: 90px;
            overflow: hidden;
        }
        ...
        /* Map Section */
        .map-section { padding-top: 0; padding-bottom: 6rem; }
        ...
        @media (max-width: 768px) {
            ...
            .contact-hero { justify-content: center; text-align: center; }
            .contact-hero-content { padding-left: 0; padding: 0 20px; }
        }
    </style>
</head>
<body>
            ...
            <div class="container">
                <div class="contact-wrapper">
                    <div class="contact-info-panel">
                        ...
                        <div class="hours-card">
                            ...
                            <div class="hours-row"><span>Monday - Friday</span> <span>6:00 AM - 8:00 PM</span></div>
                ...
                <div class="map-section">
                    <div class="map-wrapper">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15418.99539257606!2d120.6283333!3d14.9785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33965f3583168961%3A0x199271167195b053!2sSan%20Antonio%2C%20Guagua%2C%20Pampanga!5e0!3m2!1sen!2sph!4v1697520335832!5m2!1sen!2sph" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </section>
